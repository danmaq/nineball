...
namespace danmaq.nineball.state.input.legacy
{
	...
	public sealed class CStateSlider : CStateDefaultBase
	{
		...
		public static readonly CStateSlider instance = new CStateSlider();
		...
		private CStateSlider()
			: base(EAxisLegacy.Slider)
		{
		}
