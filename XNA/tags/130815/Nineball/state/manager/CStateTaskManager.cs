...
namespace danmaq.nineball.state.manager
{
	...
	public sealed class CStateTaskManager : CState<CTaskManager, CTaskManager.CPrivateMembers>
	{
		...
		public static readonly CStateTaskManager instance = new CStateTaskManager();
