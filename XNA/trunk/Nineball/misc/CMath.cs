...
namespace danmaq.nineball.misc {
	...
	public static class CMath {
		...
		public static double sec( double dRadian ) { return _sec( dRadian ); }
		...
		public static double cosec( double dRadian ) { return _cosec( dRadian ); }
		...
		public static double cotan( double dRadian ) { return _cotan( dRadian ); }
		...
		public static double asec( double dRadian ) { return _asec( dRadian ); }
		...
		public static double acosec( double dRadian ) { return _acosec( dRadian ); }
		...
		public static double acotan( double dRadian ) { return _acotan( dRadian ); }
		...
		public static double secH( double dRadian ) { return _secH( dRadian ); }
		...
		public static double cosecH( double dRadian ) { return _cosecH( dRadian ); }
		...
		/// </returns>
		public static double cotanH( double dRadian ) { return _cotanH( dRadian ); }
		...
		/// </returns>
		public static double asinH( double dRadian ) { return _asinH( dRadian ); }
		...
		/// </returns>
		public static double acosH( double dRadian ) { return _acosH( dRadian ); }
		...
		/// </returns>
		public static double atanH( double dRadian ) { return _atanH( dRadian ); }
		...
		/// </returns>
		public static double asecH( double dRadian ) { return _asecH( dRadian ); }
		...
		/// </returns>
		public static double acosecH( double dRadian ) { return _acosecH( dRadian ); }
		...
		/// </returns>
		public static double acotanH( double dRadian ) { return _acotanH( dRadian ); }
	}
}
