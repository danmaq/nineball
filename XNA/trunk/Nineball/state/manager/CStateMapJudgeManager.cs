...
namespace danmaq.nineball.state.manager
{
		...
		: CState<CMapJudgeManager<_T>, object> where _T : class, IEntity
	{
		...
		public static readonly IState<CMapJudgeManager<_T>, object> instance =
			new CStateMapJudgeManager<_T>();
		...
		/// </param>
		public override void setup(CMapJudgeManager<_T> entity, object privateMembers)
		{
		}
		...
		public override void teardown(
			CMapJudgeManager<_T> entity, object privateMembers, IState nextState)
		{
		}
	}
}
