...
namespace danmaq.nineball.state.input.xbox360
{
	...
	public sealed class CStateNoAxis : CStateDefaultBase
	{
		...
		public static readonly CStateNoAxis instance = new CStateNoAxis();
		...
		private CStateNoAxis()
			: base(EAxisXBOX360.None)
		{
		}
