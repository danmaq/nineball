@ECHO OFF
call "C:\Program Files\Adobe\Flex Builder 3\FlexFrameworkCmdPrompt.bat" "C:\Program Files\Adobe\Flex Builder 3\sdks\3.4.0" "C:\Program Files\Adobe\Flex Builder 3\jre"
