...
package danmaq.nineball.data
{
	...
	public final class CVirtualInput
	{
		 ...
		 */
		public function get assignMouseAreaList():Vector.<Rectangle>
		{
			return m_arcMouseArea;
		}
		 ...
		 */
		public function get assignKeyCodeList():Vector.<uint>
		{
			return m_auKeyCode;
		}
		 ...
		 * @return 最後にボタンの状態が更新されてからのフレーム時間
		 */
		public function get countLoop():uint
		{
			return m_uCount % keyLoop;
		}
		 ...
		 */
		public function get push():Boolean
		{
			return (hold && count == 0);
		}
		 ...
		 */
		public function get pull():Boolean
		{
			return (!hold && count == 0);
		}
		 ...
		 * @return 現在のフレームでボタンが押された場合、true
		 */
		public function get pushLoop():Boolean
		{
			return (hold && countLoop == 0);
		}
