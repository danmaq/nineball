...
package danmaq.nineball.old.data
{
	...
	public final class CInitializeData
	{
		 ...
		 * @return メインループ
		 */
		public function get mainLoop():CMainLoop
		{
			return m_mainLoop;
		}
		...
		public function get error():String
		{
			...
			if(seResolution == 0)
			{
				strErr += CSentence.SE_RESOLUTION + "\n";
			}
			if(sceneFirst == null)
			{
				strErr += CSentence.FPS_FIRST_SCENE + "\n";
			}
			return strErr;
		}
		...
		public function run():Boolean
		{
			...
			{
				throw new IllegalOperationError(CSentence.DNL_FAILED + "\n" + strError);
			}
			return bResult;
		}
