...
package danmaq.nineball.misc.math.trignometric
{
	...
	public final class CTrignometric
	{
		 ...
		 * @return 対応するセカント値
		 */
		public static function sec(fRadian:Number):Number
		{
			return 1 / Math.cos(fRadian);
		}
		 ...
		 * @return 対応するコセカント値
		 */
		public static function cosec(fRadian:Number):Number
		{
			return 1 / Math.sin(fRadian);
		}
		 ...
		 * @return 対応するコタンジェント値
		 */
		public static function cotan(fRadian:Number):Number
		{
