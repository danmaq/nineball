package danmaq.nineball.core{
	 ...
	 * @author Mc(danmaq)
	 */
	public final class CPhaseManager{
		 ...
		 * @return フェーズ値
		 */
		public function get phase():uint{ return m_uPhase; }
		 ...
		 */
		public function get phaseStartTime():uint{ return m_uPhaseStartTime; }
		 ...
		 */
		public function get phaseCount():uint{ return count - phaseStartTime; }
		 ...
		 */
		public function get isReserveNextPhase():Boolean{ return ( nextPhase >= 0 ); }
		 ...
		 */
		public function get nextPhase():int{ return m_nNextPhase; }
		...
		public function set nextPhase( value:int ):void{
			if( phase != value ){ m_nNextPhase = value; }
		}
		 ...
		 * @return 前回のフェーズ値
		 */
		public function get prevPhase():uint{ return m_uPrevPhase; }
		 ...
		 * 内部データのリセットを行います。
		 */
		public function CPhaseManager(){ reset(); }
